...
color_low = np.array([161, 155, 84], np.uint8)
color_up = np.array([179, 255, 255], np.uint8)
...
color = color_yellow # Input color, and variable that will assign the marker color
